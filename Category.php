...
//{
//    $query = "SELECT idUser from user where Useremail='".$_POST['email']."' and UserPasseword = '".$_POST['password']."' and UserFlag='1' ";
//    //echo($query);
//    $result = Select($query);
        ...
        <nav>
            <ul>
                <?php
                        ...
                        $query = "SELECT DISTINCT article.ArticleTitle,article.ArticleContent,article.ArticleDate,article.ArticleTime,article.idarticle, user.Username FROM article,user,category where category.CategoryId=".$_GET["CAT"]." and article.CategoryId=category.CategoryId and user.Iduser=article.Iduser and article.ArticleFlag=1";
                        $result = Select($query);
